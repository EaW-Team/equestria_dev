...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="automatically add focus categories")
    parser.add_argument(
        "folder",
        help="Path to mod folder"
    )
    parser.add_argument(
        "focuses",
        help="glob of focus files to use, eg. Y* will match all focus files starting with Y. Extensions are included in file names."
    )
    args = parser.parse_args()
    eaw_folder = os.path.normpath(args.folder)
