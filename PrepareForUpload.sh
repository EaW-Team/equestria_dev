...
rsync --recursive -P  --exclude='*.7z' --exclude='regexes.txt' --exclude='MTG_notes.txt' --exclude='popularities_regex.txt' --exclude='.git*' --exclude='*.sh' --exclude='*.ps1' --exclude='*.psd' --exclude='*.py' --exclude='equestria_dev.mod' . $destinationName
