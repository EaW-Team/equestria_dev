...
NDefines.NAir.AAIR_WING_MAX_STATS_DEFENCE = 300,
NDefines.NAir.AAIR_WING_MAX_STATS_AGILITY = 300,
NDefines.NAir.AAIR_WING_MAX_STATS_SPEED = 2400,
NDefines.NAir.AAIR_WING_MAX_STATS_BOMBING = 300,
