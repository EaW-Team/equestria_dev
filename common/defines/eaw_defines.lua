...
NDefines.NMilitary.LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.021   					  -- Vanilla is 0.05, air global strength damage modifier from CAS
NDefines.NMilitary.LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.043   					  -- Vanilla is 0.10, air global org damage modifier from CAS
