...
NDefines.NAI.DIPLOMACY_ACCEPT_VOLUNTEERS_BASE = 30							-- Vanilla is 50
...
NDefines.NAI.SEND_VOLUNTEER_EVAL_BASE_DISTANCE = 0.0  -- How far away it will evaluate sending volunteers if not a major power
NDefines.NAI.SEND_VOLUNTEER_EVAL_MAJOER_POWER = 0.0 	-- How willing major powers are to send volunteers.
...
NDefines.NAI.DESIRED_UNITS_FACTOR_AREA_ORDER = 0.3				-- Factor for desired number of units to assign to area defense orders
NDefines.NAI.MIN_UNITS_FACTOR_AREA_ORDER = 0.2					-- Factor for min number of units to assign to area defense orders
